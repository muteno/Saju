...
## 이 레포 전용 (saju)
- 매 세션 시작 시 사용자 의도 원문 `docs/knowledge-model/USER_INTENT_LOG.md` → 현재 아젠다 `docs/knowledge-model/PROJECT_AGENDA.md` → 기초 보강 인계 `docs/knowledge-model/FOUNDATION_HANDOFF.md` → 구현 범위 `docs/knowledge-model/CURRENT_STATE.md`·기본 풀이 계획 `docs/knowledge-model/BASIC_READING_PLAN.md`를 먼저 읽는다. 전체 시작 안내 = `AGENTS.md`.
