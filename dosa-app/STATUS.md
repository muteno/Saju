...
- 지식 주입 품질 게이트 = **블라인드 시험 루프**(/feed v2, 루트 CLAUDE.md 제1법칙): 영상=답안지, 질문 역추출→주입 전 1차 시험→격차 원인(부재/미발견/관점차이) 유추→정제 반영→새 블라인드 학생 재시험, 3라운드 실패 시 사용자 승격. 키 스캐너 판정은 전처리로 강등 — 2026-07-17 사용자 설계.
