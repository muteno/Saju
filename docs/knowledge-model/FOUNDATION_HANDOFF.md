...
갱신: 2026-09-23 · 사용자 원문 [28~37](USER_INTENT_LOG.md)
최신 완료: [PR #183](https://github.com/muteno/Saju/pull/183) 병합 · main `b92fb520a78c4a15ac77ee083e48f5ceb08bcc81`
F01 1차 작업 기준: PR #182/main `19dd97f7bd9371975da4e76300d0a72588835a33` · §3 보존 스냅샷 기준: `05a5eab0122eda37235feb66114c6c3d8249a705`
**다음 세션 첫 작업: §5.1의 합(총칭)·충(총칭) 두 항목부터. F01 1차는 병합됐고 전체 의미 검수는 남아 있다.**
...
| **F01** | **차이 76개 1차 처리·표현 1개 적용 / 전체 의미 검수 미완료** | [검토표](FOUNDATION_REVIEW.md)에서 총칭의 계층·단어 경계, 통근/온도/극 문맥, 기존 별칭의 다른 뜻을 이어 검수. 긴 별칭 추가 시 오행·자리 노드 보존 확인 | 1차 판정 66채택(65기존 보존)·5분리·5보류. 후속 채택마다 원문·반례·적용 범위·회귀 검사 연결. 승인되지 않은 이름을 실행에 섞지 않음 |
