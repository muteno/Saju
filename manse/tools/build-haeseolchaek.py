...
header .sig{{margin-top:6px;font-size:12px;color:var(--accent);font-weight:600;letter-spacing:0.02em}}
header .sig .x{{opacity:0.6;font-weight:400}}
...
<header>
  ...
  <div class="sig">契路神 <span class="x">⊗</span> 契路新 · <b>클로신</b> <span class="x">— 관측하면 하나로</span></div>
</header>
